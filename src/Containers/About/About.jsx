      ...
      <div className="card-body">
        ...
        <div className="row" id="row1">
          <div className="col-sm-12" id="Header">
            <h2 id="About" className="fw-bold font">
              About Me
            </h2>
            <p id="brand">
        ...
        <div className="row" id="row2">
          <div className="col-sm-12" id="Picture">
            ...
            <p>
              ...
              decided to pursue my passion for coding in order to solve problems
              with technology.
              <br /> <br />
              ...
              reputation for being a team leader on group projects. My strengths
              include strategizing for efficiency, communicating and organizing
              all of the details, and synergizing my team. I have hands-on
              experience in building full stack applications, including custom
              user authentication and authorization.
              <br /> <br />
              Does your company or organization need help developing or
              maintaining a website? I'll apply my skills in leadership,
              interpersonal relationships, and web development to meet all of
              your needs.
            </p>
          </div>
        </div>
